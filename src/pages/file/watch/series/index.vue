<template>
    <div class="brand-wrapper f-skin-bg pd-20">
        ...
        >
            <el-table-column align="center" label="系列ID" prop="cName" />
            <el-table-column align="center" label="系列名称" prop="cName" />
            <el-table-column align="center" label="所属品牌" prop="images">
...
import { AddReriesModal } from './popup'
...
export default {
    ...
    methods: {
        // 添加品牌
        handleCreateBrand() {
            AddReriesModal.popup().then(res => {})
        },
        // 编辑品牌
        handleEditBrand(ele) {
            AddReriesModal.popup({ formObj: { ...ele } }).then(res => {}) 
        },
        // 删除品牌
