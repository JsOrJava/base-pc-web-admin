<template>
    <div class="brand-wrapper f-skin-bg pd-20">
        ...
        >
            ...
            <el-table-column align="center" label="被评论用户昵称" prop="remark" />

            <el-table-column align="center" label="被评论用户ID" prop="remark" />

            <el-table-column align="center" label="被评论的评论id" prop="remark" />
