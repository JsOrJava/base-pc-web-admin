<template>
    <div class="brand-wrapper f-skin-bg pd-20">
        ...
        >
            <el-table-column align="center" label="视频ID" prop="cName" />
            <el-table-column align="center" label="视频标题" prop="cName" />
            <el-table-column align="center" label="所属类别" prop="cName" />
            <el-table-column align="center" label="评论数" prop="remark" />
            <el-table-column align="center" label="下载数（app显示）" prop="remark" />
            <el-table-column align="center" label="下载数（真实）" prop="remark" />

            <el-table-column align="center" label="操作" width="300">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini" @click="handleCheckComment(scope.row)">
                        查看评论
                    </el-button>
...
import { AddManageModal } from './popup'
...
export default {
    ...
    methods: {
        handleCheckComment() {
            this.$router.push({ name: 'video-manage-comment' })
        },
        // 添加品牌
        handleCreateBrand() {
            AddManageModal.popup().then(res => {})
        },
        // 编辑品牌
        handleEditBrand(ele) {
            AddManageModal.popup({ formObj: { ...ele } }).then(res => {}) 
        },
        // 删除品牌
