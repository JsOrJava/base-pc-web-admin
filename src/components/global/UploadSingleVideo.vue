...
<template>
    <div class="upload-file__wrapper clear">
        <div v-show="videoUploadUrl" class="video-wh fl mr10">
            <video
                ref="single-video"
                class="child"
                :src="videoUploadUrl"
            ...
            <i class="el-icon-circle-plus-outline expanded-icon u-btn__cursor--p" title="放大视频" @click="handlePictureCardPreview" />
            <i class="el-icon-delete delete-icon u-btn__cursor--p" title="删除视频" @click="handleRemove" />
        </div>
        <el-upload
            class="fl mr10"
